    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Agregar Miembro">
      <div className="flex flex-col gap-4">
        <input
          ...
          className="w-full bg-transparent border-b border-muted p-2 font-mono text-sm focus:border-accent"
          autoFocus
        />
        ...
        {query.length < 2 && (
          <p className="text-sm text-muted">Escribe al menos 2 caracteres para buscar</p>
        )}
      </div>
    </Modal>
  );
